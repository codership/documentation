...
.. glossary::
   ...
   Galera Replication Plugin
      ...
      .. seealso:: For more information, see :ref:`Galera Replication Plugin <galera-replication-plugin>` for more details.
   ...
   Global Transaction ID
      ...
      .. seealso:: For more information on Global Transaction ID's, see :ref:`wsrep API <wsrep-api>`.
   ...
   Incremental State Transfer
      ...
      .. seealso:: For more information on IST's, see :ref:`Incremental State Transfer (IST) <ist>`.
   ...
   Logical State Transfer Method
      ...
      .. seealso:: For more information see, :ref:`Logical State Snapshot <sst-logical>`.
   ...
   Physical State Transfer Method
      ...
      .. seealso:: For more information see, :ref:`Physical State Snapshot <sst-physical>`.
   ...
   Rolling Schema Upgrade
      ...
      .. seealso:: For more information, see :ref:`Rolling Schema Upgrade <rsu>`.
   ...
   State Snapshot Transfer
      ...
      .. seealso:: For more information, see :ref:`State Snapshot Transfer (SST) <sst>`.
   ...
   Total Order Isolation
      ...
      .. seealso:: For more information, see :ref:`Total Order Isolation <toi>`.
   ...
   Write-set Cache
      ...
      .. seealso:: For more information, see :ref:`Write-set Cache (GCache) <gcache>`.
