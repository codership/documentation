...
.. glossary::
   ...
   Primary Component
      ...
      See :doc:`weightedquorum` for more details.
   ...
   State Snapshot Transfer (SST)
      ...
      See :ref:`State Snapshot Transfer (SST) <sst>` for more details.
   ...
   Incremental State Transfer (IST)
      ...
      See :ref:`Incremental State Transfer (IST) <ist>` for more details.
   ...
   Writeset Cache (GCache)
      ...
      See :ref:`Writeset Cache (GCache) <gcache>` for more details.
   ...
   Galera Arbitrator
      ...
      See :doc:`arbitrator` for more details.
   ...
   Rolling Schema Upgrade
      ...
      See :ref:`Rolling Schema Upgrade <rsu>` for more details.
   ...
   Total Order Isolation
      ...
      See :ref:`Total Order Isolation <toi>` for more details.
