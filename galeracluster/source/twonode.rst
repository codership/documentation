...
.. note:: **Warning**: Enabling :ref:`pc.ignore_sb <pc.ignore_sb>` is dangerous in a multi-master setup due to the aforementioned risk for split-brain situations.  However, it does simplify things in master-slave clusters--especially in situations with only two nodes.
