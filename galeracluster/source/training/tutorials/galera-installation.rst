...
Galera Cluster also runs on virtual environments, such as VMware, and in cloud environments. For, for example, Amazon EC2, consider acquiring the r5.xlarge instance.
