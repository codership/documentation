...
.. csv-table::
   ...
   "``5``", "Checks made on ``READ``, ``INSERT`` and ``REPLACE`` statements. MariaDB only."
   "``6``", "Checks made on ``UPDATE``, ``DELETE``, ``INSERT`` and ``REPLACE`` statements. MariaDB only."
   "``7``", "Checks made on ``READ``,``UPDATE``, ``DELETE``, ``INSERT`` and ``REPLACE`` statements. MariaDB only."
   "``8``", "Checks made on ``SHOW`` statements."
   "``9``", "Checks made on ``READ`` and ``SHOW`` statements. MariaDB only."
   "``10``", "Checks made on ``UPDATE``, ``DELETE`` and ``SHOW`` statements. MariaDB only."
   "``11``", "Checks made on ``READ``, ``UPDATE``, ``DELETE`` and ``SHOW`` statements. MariaDB only."
   "``12``", "Checks made on ``INSERT``, ``REPLACE``, and ``SHOW`` statements. MariaDB only."
   "``13``", "Checks made on ``READ``, ``INSERT``, ``REPLACE``, and ``SHOW`` statements. MariaDB only."
   "``14``", "Checks made on ``UPDATE``, ``DELETE``, ``INSERT``, ``REPLACE``, and ``SHOW`` statements. MariaDB only."
   "``15``", "Checks made on ``READ``, ``UPDATE``, ``DELETE``, ``INSERT``, ``REPLACE``, and ``SHOW`` statements. MariaDB only."
