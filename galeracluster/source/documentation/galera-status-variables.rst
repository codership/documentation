...
Average distance between highest and lowest seqno value that can be possibly applied in parallel (potential degree of parallelization). Notice that this is an average measure. You will not see acute changes in this variable.
