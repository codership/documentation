...
.. note:: For more information on the Auto Eviction process, see :doc:`auto-eviction`.
...
.. note:: For more information on the delayed list and the Auto Eviction process, see :doc:`auto-eviction`.
...
.. note:: For more information on the eviction and Auto Eviction process, see :doc:`auto-eviction`.
...
.. note:: For more information, see :ref:`evs.send_window <evs.send_window>`.
...
.. note:: For more information on the procedure to upgrade from one version to another, see :ref:`Upgrading the EVS Protocol <upgrade-evs>`.
...
.. note:: For more information on customizing the write-set cache, see the :doc:`Best Practice Articles <../kb/best/index>`.
...
.. note:: For more information on generating :abbr:`SSL (Secure Socket Layer)` certificate files for your cluster, see :doc:`ssl-cert`.
